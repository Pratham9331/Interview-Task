...
using SearchSortPagingTaskDAL.Entites;

namespace SearchSortPagingTaskDAL
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@" Data Source=Prathamesh;Initial Catalog= SearchSortPagingTask; Integrated Security=True; Encrpyt=False;");
            }
        }
